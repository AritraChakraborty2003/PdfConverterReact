...
const HiringDoc = () => {
  ...
  const getPDF = (e) => {
    ...
    if (role === "Android Development") {
      ...
      doc.text(
        `4. Working primarily on java and creating robust looking UI of VentureLink app using XML`,
        20,
        191
      );
    }
    ...
    if (role === "Marketing") {
      ...
      doc.text(
        `4. Regularly posting on social media platform making discussion with UI/UX team with suitable and catchy content`,
        20,
        191
      );
    }
